import { insertChildOrderly, getChildTabNodes, getTabIndexFromName, getChildrenTotalWidth, getChildrenTotalWidthUpToClickedTab, isNotSameChildren, getUpdatedTabsetChildren, getLeftButtonDisabledState, getRightButtonDisabledState } from '../utils';
describe('<Tabset/> utils', function () {
  ...
  describe('getUpdatedTabsetChildren', function () {
    it('should return an updated tabset with the changed tab when a name to update exist in the tabset children', function () {
      ...
      expect(getUpdatedTabsetChildren(tabsetChildren, tab, nameToUpdate)).toEqual(newTabsetChildren);
    });
    it('should return the same tabset when a name to update do not exist in the tabset children', function () {
      ...
      expect(getUpdatedTabsetChildren(tabsetChildren, tab, nameToUpdate)).toEqual(tabsetChildren);
    });
  });
