...
var PageCodeInput = function () {
  function PageCodeInput(rootElement) {
    _classCallCheck(this, PageCodeInput);

    this.rootElement = rootElement;
  }

  _createClass(PageCodeInput, [{
    key: "type",
    value: function () {
      var _type = _asyncToGenerator(_regeneratorRuntime.mark(function _callee(key) {
        var focusedInput;
    ...
    value: function () {
      var _clickInputAtIndex = _asyncToGenerator(_regeneratorRuntime.mark(function _callee3(inputIndex) {
        var input;
    ...
    key: "getFocusedIndex",
    value: function () {
      var _getFocusedIndex = _asyncToGenerator(_regeneratorRuntime.mark(function _callee4() {
        var focusedInput;
    ...
    key: "getFocusedValue",
    value: function () {
      var _getFocusedValue = _asyncToGenerator(_regeneratorRuntime.mark(function _callee5() {
        var focusedInput;
    ...
    value: function () {
      var _getInputValueAtIndex = _asyncToGenerator(_regeneratorRuntime.mark(function _callee6(inputIndex) {
        var input;
    ...
    key: "getFocusedInput",
    value: function () {
      var _getFocusedInput = _asyncToGenerator(_regeneratorRuntime.mark(function _callee8() {
            ...
            switch (_context8.prev = _context8.next) {
              ...
              case 2:
                ...
                return Promise.all(inputs.map(function () {
                  var _ref = _asyncToGenerator(_regeneratorRuntime.mark(function _callee7(input) {
    ...
    key: "getInputAtIndex",
    value: function () {
      var _getInputAtIndex = _asyncToGenerator(_regeneratorRuntime.mark(function _callee9(inputIndex) {
        var input;
