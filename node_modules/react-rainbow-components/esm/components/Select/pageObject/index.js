...
var PageSelect = function () {
  ...
  _createClass(PageSelect, [{
    ...
    key: "hasFocusSelect",
    value: function () {
      var _hasFocusSelect = _asyncToGenerator(_regeneratorRuntime.mark(function _callee3() {
    ...
    key: "isSelectedItem",
    value: function () {
      var _isSelectedItem = _asyncToGenerator(_regeneratorRuntime.mark(function _callee4(itemPosition) {
        var items;
