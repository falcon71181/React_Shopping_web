...
function SvgKyrgyzstan(_ref) {
  ...
  return React.createElement("svg", {
    ...
    d: "M13.565 16c-.117 0-.233.006-.347.017a2.77 2.77 0 00.65 1.772 4.88 4.88 0 01.942-1.558A3.46 3.46 0 0013.565 16zM15.064 18.62a2.776 2.776 0 001.872 0A3.48 3.48 0 0016 16.998a3.48 3.48 0 00-.936 1.624zM18.41 14.61a2.781 2.781 0 00-4.82 0c.877.004 1.7.242 2.41.654a4.837 4.837 0 012.41-.655zM17.19 16.231c.405.452.726.98.94 1.558a2.77 2.77 0 00.652-1.772 3.49 3.49 0 00-1.592.214z"
  }))));
}
