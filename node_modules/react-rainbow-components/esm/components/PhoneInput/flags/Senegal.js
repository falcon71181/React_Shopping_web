...
function SvgSenegal(_ref) {
  ...
  return React.createElement("svg", {
    ...
    d: "M16 10.435l1.381 4.251h4.47l-3.616 2.628 1.381 4.251L16 18.938l-3.617 2.627 1.382-4.251-3.617-2.628h4.47zM9.043 1.588C3.692 4.176 0 9.657 0 16s3.692 11.824 9.043 14.412V1.588z"
  })), React.createElement("path", {
...
SvgSenegal.propTypes = {
  className: PropTypes.string,
  style: PropTypes.object
};
SvgSenegal.defaultProps = {
  className: undefined,
  style: undefined
};
