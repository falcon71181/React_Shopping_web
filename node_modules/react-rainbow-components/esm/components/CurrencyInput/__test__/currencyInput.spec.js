...
var TestCurrencyInput = function TestCurrencyInput(props) {
...
describe('<CurrencyInput />', function () {
  it('should mount a input with a value of $5.00', function () {
    [5, '5', '5.', '5.00', '5.00003'].forEach(function (value) {
      render(React.createElement(CurrencyInput, {
        value: value
      }));
    });
  ...
  it('should mount a input with a value of $0.00', function () {
  ...
  it('should mount a input with a value of "-"', function () {
    var _render = render(React.createElement(CurrencyInput, {
      value: "-"
    })),
  ...
  it('should be change value to 5 when is fucused', function () {
    var _render2 = render(React.createElement(CurrencyInput, {
      value: 5
    })),
  ...
  it('should be change value to $5.00 when is not focused', function () {
    var _render3 = render(React.createElement(CurrencyInput, {
      value: 5
    })),
  ...
  it('should fire onChange with the value when it is a valid value', function () {
    ...
    var _render4 = render(React.createElement(CurrencyInput, {
  ...
  it('should not fire onChange with the value when it is an invalid value', function () {
    ...
    var _render5 = render(React.createElement(CurrencyInput, {
      onChange: onChangeMockFn
    })),
    ...
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _render6 = render(React.createElement(TestCurrencyInput, null)), getByRole = _render6.getByRole;
    ...
    return _regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _render7 = render(React.createElement(TestCurrencyInput, {
              initialValue: 1234
    ...
    return _regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _render8 = render(React.createElement(TestCurrencyInput, {
    ...
    return _regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _render9 = render(React.createElement(TestCurrencyInput, {
              initialValue: "0.0"
