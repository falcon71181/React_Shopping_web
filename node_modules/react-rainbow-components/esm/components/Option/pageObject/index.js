...
function _isPointWithinRect() {
  _isPointWithinRect = _asyncToGenerator(_regeneratorRuntime.mark(function _callee10(point, rect) {
...
var PageOption = function () {
  function PageOption(rootElement, containerRect) {
    _classCallCheck(this, PageOption);

    this.rootElement = rootElement;
    this.containerRect = containerRect;
  }

  _createClass(PageOption, [{
    key: "click",
    value: function () {
    ...
    key: "getLabel",
    value: function () {
      var _getLabel = _asyncToGenerator(_regeneratorRuntime.mark(function _callee3() {
    ...
    key: "isActive",
    value: function () {
      var _isActive = _asyncToGenerator(_regeneratorRuntime.mark(function _callee4() {
    ...
    key: "isVisible",
    value: function () {
      var _isVisible = _asyncToGenerator(_regeneratorRuntime.mark(function _callee6() {
    ...
    value: function () {
      var _waitUntilIsVisible = _asyncToGenerator(_regeneratorRuntime.mark(function _callee8() {
        var _this = this;
    ...
    key: "scrollIntoView",
    value: function () {
      var _scrollIntoView = _asyncToGenerator(_regeneratorRuntime.mark(function _callee9() {
