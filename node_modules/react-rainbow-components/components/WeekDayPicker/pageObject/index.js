...
var PageWeekDayPicker = function () {
  ...
  (0, _createClass2["default"])(PageWeekDayPicker, [{
    key: "clickOn",
    value: function () {
      var _clickOn = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee(weekDay) {
        var inputRef;
    ...
    key: "getSelectedDays",
    value: function () {
      var _getSelectedDays = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee3() {
        var _this = this;
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                return Promise.all(weekDays.map(function () {
                  var _ref = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee2(weekDay) {
                    var input;
    ...
    key: "getFocusedDay",
    value: function () {
      var _getFocusedDay = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee5() {
        var _this2 = this;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return Promise.all(weekDays.map(function () {
                  var _ref2 = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee4(weekDay) {
                    var input;
    ...
    key: "getInput",
    value: function () {
      var _getInput = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee6(weekDay) {
        var index, elem;
    ...
    key: "getInputRef",
    value: function () {
      var _getInputRef = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee7(weekDay) {
        var index, elem;
