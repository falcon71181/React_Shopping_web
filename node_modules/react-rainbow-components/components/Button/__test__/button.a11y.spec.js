...
describe('<Button/>', function () {
  ...
  it('should be accessible when text is passed as children', (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee2() {
    var html, results;
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            expect.assertions(1);
            html = _server["default"].renderToString(_react["default"].createElement(_["default"], null, "button text"));
            _context2.next = 4;
            return (0, _axe["default"])(html);
