...
var CurrencyInput = (0, _react.forwardRef)(function (props, ref) {
  ...
  var options = (0, _hooks2.useOptions)(props);
  ...
  var normalizedValue = (0, _helpers.normalizeValue)({
    value: value,
    locale: locale,
    decimalSeparator: decimalSeparator,
    options: options
  });
  var currentValue = focused ? normalizedValue : (0, _helpers.formatCurrency)({
    value: value,
    locale: locale,
    options: options
  });
  ...
  var handleChange = function handleChange(event) {
    ...
    var normalizeNewValue = (0, _helpers.normalizeValue)({
      value: cleanValue,
      locale: locale,
      decimalSeparator: decimalSeparator,
      options: options
